...
import (
	...
	apikeyaliascontroller "github.com/seakee/cpa-statistics/apps/manager-server/internal/http/controller/apikeyalias"
	datacontroller "github.com/seakee/cpa-statistics/apps/manager-server/internal/http/controller/data"
	dashboardcontroller "github.com/seakee/cpa-statistics/apps/manager-server/internal/http/controller/dashboard"
	healthcontroller "github.com/seakee/cpa-statistics/apps/manager-server/internal/http/controller/health"
	managerconfigcontroller "github.com/seakee/cpa-statistics/apps/manager-server/internal/http/controller/managerconfig"
	modelpricecontroller "github.com/seakee/cpa-statistics/apps/manager-server/internal/http/controller/modelprice"
	monitoringcontroller "github.com/seakee/cpa-statistics/apps/manager-server/internal/http/controller/monitoring"
	panelcontroller "github.com/seakee/cpa-statistics/apps/manager-server/internal/http/controller/panel"
	proxycontroller "github.com/seakee/cpa-statistics/apps/manager-server/internal/http/controller/proxy"
	setupcontroller "github.com/seakee/cpa-statistics/apps/manager-server/internal/http/controller/setup"
	systemcontroller "github.com/seakee/cpa-statistics/apps/manager-server/internal/http/controller/system"
	usagecontroller "github.com/seakee/cpa-statistics/apps/manager-server/internal/http/controller/usage"
...
func New(appCtx *app.Context) http.Handler {
	...
	dataHandler := &datacontroller.Handler{App: appCtx}
	...
	mux.HandleFunc("/", rootHandler(appCtx, usageHandler, apiKeyAliasHandler, modelPriceHandler, dataHandler, dashboardHandler, monitoringHandler, proxyHandler))
...
func rootHandler(
	...
	dataHandler *datacontroller.Handler,
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.HasPrefix(r.URL.Path, "/v0/management/data/") {
			middleware.WithCORS(appCtx.Config, dataHandler.Handle)(w, r)
			return
		}
